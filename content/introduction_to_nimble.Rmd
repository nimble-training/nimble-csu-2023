...
* Original data from "Vicente et al. (2005)", citing [this](https://doi.org/10.1051/vetres:2005044), although we're not sure they cited the right paper!
* 826 total deer.
...
We can set data and inits at the `nimbleModel` step (above) or now:
...
Consider setting up a Metropolis-Hastings, slice, or Hamiltonian sampler on a subset of nodes in the model. 
